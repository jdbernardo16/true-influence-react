      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          ...
          <p className="text-lg text-[#faf8f5]/80 font-light leading-relaxed mb-10 max-w-2xl mx-auto">
            Choose your starting phase and take the first step toward becoming a
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 bg-transparent border-2 border-[#d4952a] text-[#d4952a] hover:bg-[#d4952a]/10 px-8 py-4 rounded-full font-medium transition-all duration-300 cursor-pointer"
            >
              <span className="uppercase tracking-wider">
