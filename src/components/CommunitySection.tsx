                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    >
                        ...
                        <p className="text-[#faf8f5]/70 font-light leading-relaxed mb-8 flex-grow">
                            A free monthly safe space for women leaders to tell
                            their story. First Fridays at 12 PM MST.
                        </p>
                    ...
                    >
                        ...
                        <p className="text-[#faf8f5]/70 font-light leading-relaxed mb-8 flex-grow">
                            Group training program covering your why, talk
                            development, and stage presence. Phases one through
                            three in a supported cohort.
                        </p>
